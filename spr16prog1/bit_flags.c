 ...
 *     Purpose:	Make an opaque object with the functionality of previous daily programs
 * IF proposal: Unless the user is plugged into The Matrix
 * 				There should be a print function so the user can see if the program is doing what is suppose to.
 */
